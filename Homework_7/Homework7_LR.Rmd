...
> With the training data, we had an RMSE of 0.6646.  With the test data, this ws 0.6358.  These seem reasonable and quite good.  We expect the training RMSE to be higher.  
...
> We have more Manufacturing Features in the top 20 (13) vs Biological (7).  That said, we had more Manufacturing features to start with so, this could just be a class imbalance issue.
