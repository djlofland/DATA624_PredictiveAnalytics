...
colnames(predictions) <- c('Date Time', 'WaterFlow')

pred_df <- as.data.frame(predictions)
pred_df$WaterFlow <- as.numeric(pred_df$WaterFlow)

# Append forecast values to end of original dataset
waterflow_output_df <- rbind(pipes2_ts, pred_df)
...
[https://github.com/djlofland/DATA624_PredictiveAnalytics/tree/master/Project_1/datsets/waterflow_final.csv](https://github.com/djlofland/DATA624_PredictiveAnalytics/tree/master/Project_1/datsets/waterflow_final.csv)
